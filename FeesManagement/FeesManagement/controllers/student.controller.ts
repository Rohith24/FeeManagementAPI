...
router.get("/retrieve", async (request: express.Request, response: express.Response) => {
    /*  #swagger.auto = false
        ...
        #swagger.path = '/student/retrieve'
        #swagger.summary = 'User retrieve service'
        #swagger.tags = ['User']
        #swagger.method = 'get'
    ...
    */
    //logger.info(request, "request body", "Student/Retrieve", request.query.objectCode, "request", '5');
